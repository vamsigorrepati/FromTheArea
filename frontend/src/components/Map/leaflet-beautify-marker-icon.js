    ...
    L.BeautifyIcon = {
        ...
        Icon: L.Icon.extend({
            ...
            createIcon: function () {
                ...
                shadow.src = 'leaflet/images/marker-shadow.png'; // Your shadow image URL
                shadow.className = 'leaflet-marker-shadow';
                shadow.style.cssText = "margin-top: -42px; margin-left: -12px;"; // Adjust the values as needed
                ...
                this._setIconStyles(iconDiv, 'icon');
            
                // If a marker shape is required, wrap it with an extra div for rotation correction
                if (this.options.iconShape === 'marker') { 
                    var wrapperDiv = document.createElement('div');
                    wrapperDiv.className = 'beautify-marker';
                    wrapperDiv.appendChild(shadow); // Shadow is appended to wrapperDiv before iconDiv
                    wrapperDiv.appendChild(iconDiv);
                    return wrapperDiv;
                }
            
                // Append shadow directly to iconDiv if no wrapperDiv is needed
                iconDiv.insertBefore(shadow, iconDiv.firstChild);
